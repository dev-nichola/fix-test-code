...
// {
//   function addProduct($value, $route)
//   {
//     $html = "<form action='$route' method='POST'";
//     $html .= "p<input type='hidden' name='_token' value='".csrf_token()."'>";

//     $html .= "<button data-id='$value' class='btn btn-primary btn-sm' type='submit'>Add Product</button>";
//     $html .= "</form>";
